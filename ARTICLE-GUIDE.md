...
# Article Guide — kaca.tukang.co.id
...
Source route evidence: sitemap XML, 1560 routes discovered during packet generation
...
- Address the reader warmly as `Sobat Tukang.co.id`, `Kawan Tukang.co.id`, or `Teman Tukang.co.id`. Use the exact opening salutation assigned inside the article file.
