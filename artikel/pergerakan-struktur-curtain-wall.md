---
article_id: KTG-03-03
title: "Pergerakan Struktur dan Sambungan Curtain Wall"
slug: "pergerakan-struktur-curtain-wall"
description: "Define system, movement, water, thermal, and interface requirements"
status: outline
publication_date: "2025-10-19"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KTG-03
primary_intent: "Plan movement accommodation"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/pergerakan-struktur-curtain-wall.html"
...
# Pergerakan Struktur dan Sambungan Curtain Wall

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pergerakan Struktur dan Sambungan Curtain Wall”
- **Reader and situation:** Define system, movement, water, thermal, and interface requirements
- **Reader outcome:** Define system, movement, water, thermal, and interface requirements
- **Primary intent:** Plan movement accommodation
...
- **Scope boundary:** Coordination inputs; no movement calculation
- **Final public route:** `/artikel/pergerakan-struktur-curtain-wall.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pergerakan Struktur dan Sambungan Curtain Wall**.
...
- `/jasa-pasang-curtain-wall-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-curtain-wall-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-curtain-wall-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-curtain-wall-tulungagung` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-curtain-wall-tuban` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-curtain-wall-trenggalek` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `KTG-03-01` → `/artikel/stick-vs-unitized-curtain-wall.html` — Stick, Unitized, atau Semi-Unitized Curtain Wall
- `KTG-03-02` → `/artikel/jalur-air-drainase-curtain-wall.html` — Jalur Air dan Drainase pada Curtain Wall
- `KTG-03-04` → `/artikel/spandrel-vs-vision-glass-fasad.html` — Spandrel, Vision Glass, dan Zona Opak Fasad
- `KTG-03-05` → `/artikel/mockup-uji-curtain-wall.html` — Mockup dan Uji Kinerja Curtain Wall
...
- **Tie back to this article:** Keep the explanation specific to “Pergerakan Struktur dan Sambungan Curtain Wall”.
