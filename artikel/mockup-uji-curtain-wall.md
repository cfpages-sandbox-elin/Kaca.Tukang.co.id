---
article_id: KTG-03-05
title: "Mockup dan Uji Kinerja Curtain Wall"
slug: "mockup-uji-curtain-wall"
...
date_modified: null
parent_topic: KTG-03
primary_intent: "Plan facade verification"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/mockup-uji-curtain-wall.html"
...
# Mockup dan Uji Kinerja Curtain Wall

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mockup dan Uji Kinerja Curtain Wall”
...
- **Primary intent:** Plan facade verification
...
- **Scope boundary:** Test planning; criteria project-specific
- **Final public route:** `/artikel/mockup-uji-curtain-wall.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mockup dan Uji Kinerja Curtain Wall**.
...
- `KTG-03-06` → `/artikel/interface-curtain-wall-struktur-atap.html` — Checklist Interface Curtain Wall dengan Struktur dan Atap
...
- **Tie back to this article:** Keep the explanation specific to “Mockup dan Uji Kinerja Curtain Wall”.
