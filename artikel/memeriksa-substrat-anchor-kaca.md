---
article_id: KTG-10-03
title: "Memeriksa Substrat dan Area Anchor Sebelum Fabrikasi"
slug: "memeriksa-substrat-anchor-kaca"
...
date_modified: null
parent_topic: KTG-10
primary_intent: "Verify supporting interfaces"
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/memeriksa-substrat-anchor-kaca.html"
...
# Memeriksa Substrat dan Area Anchor Sebelum Fabrikasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memeriksa Substrat dan Area Anchor Sebelum Fabrikasi”
...
- **Primary intent:** Verify supporting interfaces
...
- **Scope boundary:** Structural capacity requires responsible review
- **Final public route:** `/artikel/memeriksa-substrat-anchor-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memeriksa Substrat dan Area Anchor Sebelum Fabrikasi**.
...
- `KTG-10-01` → `/artikel/checklist-survei-pekerjaan-kaca.html` — Checklist Survei Lapangan Pekerjaan Kaca
- `KTG-10-02` → `/artikel/mengukur-bukaan-untuk-kaca.html` — Mengukur Bukaan yang Tidak Siku dan Tidak Level
- `KTG-10-04` → `/artikel/koordinasi-kaca-waterproofing-drainase.html` — Koordinasi Kaca dengan Waterproofing dan Drainase
...
- **Tie back to this article:** Keep the explanation specific to “Memeriksa Substrat dan Area Anchor Sebelum Fabrikasi”.
