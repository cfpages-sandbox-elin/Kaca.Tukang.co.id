---
article_id: KTG-09-03
title: "Kaca Grafir vs Sandblast untuk Motif Dekoratif"
slug: "grafir-vs-sandblast-kaca"
description: "Choose mirror, engraving, inlay, stained/patri, colour, and backing safely"
status: outline
publication_date: "2026-03-15"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KTG-09
primary_intent: "Compare surface decoration"
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/grafir-vs-sandblast-kaca.html"
...
# Kaca Grafir vs Sandblast untuk Motif Dekoratif

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kaca Grafir vs Sandblast untuk Motif Dekoratif”
- **Reader and situation:** Choose mirror, engraving, inlay, stained/patri, colour, and backing safely
- **Reader outcome:** Choose mirror, engraving, inlay, stained/patri, colour, and backing safely
- **Primary intent:** Compare surface decoration
...
- **Scope boundary:** Decorative process choice; safety make-up separate
- **Final public route:** `/artikel/grafir-vs-sandblast-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kaca Grafir vs Sandblast untuk Motif Dekoratif**.
...
- **Exact Markdown to insert:** `![Ilustrasi kaca grafir](/wp-content/uploads/2023/08/kaca-grafir.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `kaca grafir` as relevant content media; no pixels were inspected.
...
- `/jasa-pasang-kaca-grafir-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-kaca-grafir-wonosobo` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-kaca-grafir-wonogiri` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-kaca-grafir-tulungagung` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-kaca-grafir-tuban` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa-pasang-kaca-grafir-trenggalek` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `KTG-09-01` → `/artikel/memilih-cermin-menurut-area.html` — Memilih Kaca Cermin untuk Area Kering dan Basah
- `KTG-09-02` → `/artikel/cermin-panel-besar-vs-segmen.html` — Cermin Dinding vs Panel Cermin Bersegmen
- `KTG-09-04` → `/artikel/brief-desain-kaca-inlay.html` — Kaca Inlay: Desain Sambungan, Warna, dan Sampel
- `KTG-09-05` → `/artikel/kaca-patri-untuk-interior.html` — Kaca Patri untuk Interior: Panel, Cahaya, dan Proteksi
...
- **Tie back to this article:** Keep the explanation specific to “Kaca Grafir vs Sandblast untuk Motif Dekoratif”.
