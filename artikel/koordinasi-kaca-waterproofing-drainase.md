---
article_id: KTG-10-04
title: "Koordinasi Kaca dengan Waterproofing dan Drainase"
slug: "koordinasi-kaca-waterproofing-drainase"
description: "Capture openings, substrates, levels, services, tolerances, and access"
status: outline
publication_date: "2026-04-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KTG-10
primary_intent: "Avoid interface conflicts"
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/koordinasi-kaca-waterproofing-drainase.html"
...
# Koordinasi Kaca dengan Waterproofing dan Drainase

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Koordinasi Kaca dengan Waterproofing dan Drainase”
- **Reader and situation:** Capture openings, substrates, levels, services, tolerances, and access
- **Reader outcome:** Capture openings, substrates, levels, services, tolerances, and access
- **Primary intent:** Avoid interface conflicts
...
- **Scope boundary:** Adjacent-system coordination only
- **Final public route:** `/artikel/koordinasi-kaca-waterproofing-drainase.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Koordinasi Kaca dengan Waterproofing dan Drainase**.
...
- `KTG-10-02` → `/artikel/mengukur-bukaan-untuk-kaca.html` — Mengukur Bukaan yang Tidak Siku dan Tidak Level
- `KTG-10-03` → `/artikel/memeriksa-substrat-anchor-kaca.html` — Memeriksa Substrat dan Area Anchor Sebelum Fabrikasi
- `KTG-10-05` → `/artikel/koordinasi-kaca-dengan-mep-finishing.html` — Koordinasi Kaca dengan MEP, Plafon, dan Finishing
- `KTG-10-06` → `/artikel/hold-point-release-ukuran-kaca.html` — Hold Point Sebelum Ukuran Kaca Dilepas ke Produksi
...
- **Tie back to this article:** Keep the explanation specific to “Koordinasi Kaca dengan Waterproofing dan Drainase”.
