# Global Research — kaca.tukang.co.id
...
Catalog covered: **14 topic families / 84 planned articles** in [`ARTICLE_CATALOG.md`](ARTICLE_CATALOG.md)

Authority boundary: [`TOPICAL_AUTHORITY.md`](TOPICAL_AUTHORITY.md)

## Purpose

This is the reusable pre-writing evidence layer for the complete `kaca.tukang.co.id` catalog. It reuses authoritative research from its broader project family, then maps that evidence to this repository's frozen topic families so related sites do not repeat the same source discovery.
...
- **Purpose:** Freeze the verified editorial scope for `kaca.tukang.co.id` and prevent family research from overriding this project's actual catalog boundaries.
- **Summary:** `kaca.tukang.co.id` is a member of **F01 Glass, glazing, tempered glass, and applied film**. Shared evidence is reused here, but its applicability is filtered through this project's topic map, application, jurisdiction, product, and installed-system gates.
...
- **Incorporation:** Use in `KTG-01`, `KTG-02`, `KTG-03`, `KTG-04`, `KTG-05`, `KTG-06`, `KTG-07`, `KTG-08`, `KTG-09`, `KTG-10`, `KTG-11`, `KTG-12`, `KTG-13`, `KTG-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-01`, `KTG-03`, `KTG-11`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-01`, `KTG-03`, `KTG-07`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-08`, `KTG-12`, `KTG-13`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-01`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-02`, `KTG-05`, `KTG-06`, `KTG-09`, `KTG-10`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-05`, `KTG-06`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-09`, `KTG-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-07`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-10`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-02`, `KTG-04`, `KTG-05`, `KTG-06`, `KTG-09`, `KTG-10`, `KTG-11`, `KTG-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-11`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-02`, `KTG-04`, `KTG-06`, `KTG-08`, `KTG-10`, `KTG-12`, `KTG-13`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-01`, `KTG-03`, `KTG-12`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-08`, `KTG-13`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-05`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-03`, `KTG-04`, `KTG-07`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-02`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-07`, `KTG-09`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KTG-04`, `KTG-08`, `KTG-11`, `KTG-12`, `KTG-13`, `KTG-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
| --- | --- | --- | --- |
| `KTG-01` | KR-01, KR-02, KR-15, KR-03, KR-05 | Service selection and project brief; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-04; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-02` | KR-01, KR-06, KR-12, KR-14, KR-20 | Glass type and safety specification; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-04; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-03` | KR-01, KR-02, KR-15, KR-19, KR-03 | Curtain wall; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-06, GATE-07; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-04` | KR-01, KR-12, KR-14, KR-19, KR-22 | Spider and point-fixed glazing; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-05` | KR-01, KR-06, KR-07, KR-12, KR-18 | Glass canopies; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-06` | KR-01, KR-06, KR-07, KR-12, KR-14 | Glass railings; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-07` | KR-01, KR-03, KR-10, KR-19, KR-21 | Glass doors and partitions; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-04, GATE-05, GATE-06; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-08` | KR-01, KR-14, KR-16, KR-04, KR-22 | Shower enclosures; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-09` | KR-01, KR-06, KR-08, KR-12, KR-21 | Mirrors and decorative glass; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-10` | KR-01, KR-12, KR-14, KR-06, KR-11 | Site survey and design coordination; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-04, GATE-06; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-11` | KR-01, KR-13, KR-22, KR-12, KR-02 | Fabrication and submittals; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-04, GATE-05; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-12` | KR-01, KR-04, KR-14, KR-15, KR-22 | Installation and quality control; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-04, GATE-05, GATE-07, GATE-08; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-13` | KR-01, KR-04, KR-14, KR-16, KR-22 | Inspection, cleaning, and repair; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-04, GATE-05, GATE-07, GATE-08; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KTG-14` | KR-01, KR-09, KR-22, KR-08, KR-12 | Scope, estimating, and procurement; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-08; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |

Coverage result: **14/14 topic families mapped; 0 families without a starting evidence set.**
...
| --- | --- | --- |
| `GATE-01` licensed standards | `KTG-01`, `KTG-02`, `KTG-03`, `KTG-04`, `KTG-05`, `KTG-06`, `KTG-07`, `KTG-08`, `KTG-09`, `KTG-10`, `KTG-11`, `KTG-12`, `KTG-13`, `KTG-14` | Obtain and review current applicable standards before using exact requirements, tolerances, classifications, test values, or acceptance criteria. |
| `GATE-02` Indonesian application and approval basis | `KTG-01`, `KTG-02`, `KTG-03`, `KTG-04`, `KTG-05`, `KTG-06`, `KTG-07`, `KTG-08`, `KTG-09`, `KTG-10`, `KTG-11`, `KTG-12`, `KTG-13`, `KTG-14` | Identify the current Indonesian national/local rule, approval path, and project specification that govern the actual application. |
| `GATE-03` qualified technical design | `KTG-03`, `KTG-04`, `KTG-05`, `KTG-06`, `KTG-08`, `KTG-09`, `KTG-14` | A competent professional must verify design inputs, loads, interfaces, failure consequences, and the complete installed configuration. |
| `GATE-04` current product/system evidence | `KTG-01`, `KTG-02`, `KTG-03`, `KTG-04`, `KTG-05`, `KTG-06`, `KTG-07`, `KTG-08`, `KTG-09`, `KTG-10`, `KTG-11`, `KTG-12`, `KTG-13`, `KTG-14` | Obtain exact current datasheets, test reports, listings/certificates, configurations, limitations, and evidence traceable to the offered product/system. |
| `GATE-05` manufacturer compatibility and instructions | `KTG-07`, `KTG-08`, `KTG-11`, `KTG-12`, `KTG-13` | Obtain written compatibility, processing, installation, cleaning, maintenance, cure, and warranty instructions for selected materials/products. |
| `GATE-06` site, user, and exposure facts | `KTG-03`, `KTG-07`, `KTG-08`, `KTG-10` | Verify dimensions, supports/substrates, environment, access, users, existing condition, interfaces, drainage, and operational constraints. |
| `GATE-07` K3 and safe execution | `KTG-03`, `KTG-08`, `KTG-12`, `KTG-13` | Approve task-specific competent personnel, method, access/lifting controls, exclusion zones, PPE, emergency response, and stop-work conditions. |
| `GATE-08` commercial, contract, and handover facts | `KTG-12`, `KTG-13`, `KTG-14` | Verify current scope, quotation assumptions, competence, submittals, exclusions, schedule, warranty, QC, traceability, and handover records. |
